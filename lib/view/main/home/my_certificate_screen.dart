...
import 'package:grin/core/widgets/my_certificate_container.dart';
    ...
    return Scaffold(
      body: SafeArea(child: SingleChildScrollView(child: Padding(
        ...
        child: Column(
          ...
          children: [
          Text("Certificates received",style: Theme.of(context).textTheme.titleLarge?.copyWith(fontWeight: FontWeight.w600,fontSize: 21),)
        ,
...
ListView.builder(
  ...
  return CertificateContainer(image: certificate["image"] ?? "no data", title: certificate["title"]??"no data");
},),
          ],),
      ),)),
    );
